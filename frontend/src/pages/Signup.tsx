...
import { Mail, Lock, Eye, EyeOff, CheckCircle, XCircle, Chrome, Github, Linkedin } from 'lucide-react';
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-background-card/50 backdrop-blur-xl border border-zinc-800 p-8 sm:p-10 rounded-2xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-xs text-text-muted">
            ...
            <Button type="submit" fullWidth className="h-12 text-lg font-bold mt-2">
              Sign Up
            </Button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-text-muted">
            ...
            <button onClick={() => onChangeView(AppView.LOGIN)} className="font-medium text-primary hover:underline hover:text-primary-hover">
              Log In
            </button>
          </p>
        </div>
